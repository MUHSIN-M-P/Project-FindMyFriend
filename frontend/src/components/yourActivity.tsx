        ...
        <div className="content flex flex-col items-center w-full lg:px-3 border-3 border-l-0 max-lg:border-b-0! max-lg:border-r-0! border-retro_border">
            ...
            <div className="lg:py-3">
                {notifications.map((notification, index) => {
                    if (notification.type == "private_room_no")
                        return (
                            <div
                                key={index}
                                className="flex items-center gap-3 p-3 px-3 max-lg:px-0 text-base"
                            >
                                <img src="/icons/pen_icon.svg" alt="pen" />
                                <p>{`You have ${notification.no} more private rooms to join`}</p>
                            </div>
                        );
